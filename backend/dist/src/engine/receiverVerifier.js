...
exports.verifyReceiverVpa = verifyReceiverVpa;
const threatDb_1 = require("./threatDb");
function verifyReceiverVpa(vpa, claimedName) {
    ...
    const handleBank = threatDb_1.OFFICIAL_PSP_HANDLES[handle];
    const isOfficialPspHandle = !!handleBank;
    const isBlacklistedHandle = threatDb_1.KNOWN_SUSPICIOUS_HANDLES.some(sus => cleanVpa.includes(sus) || handle.includes(sus));
