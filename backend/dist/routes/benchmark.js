...
exports.benchmarkRouter.get('/scenarios', (req, res) => {
    return res.json(scamScenarios_1.SCAM_SCENARIOS);
});
// POST run benchmark test suite
exports.benchmarkRouter.post('/run', (req, res) => {
    ...
    for (const scenario of scamScenarios_1.SCAM_SCENARIOS) {
        const itemStart = Date.now();
        const analysis = (0, riskCalculator_1.calculateComprehensiveRisk)(scenario.rawInput, scenario.inputType);
    ...
    const totalScenarios = scamScenarios_1.SCAM_SCENARIOS.length;
